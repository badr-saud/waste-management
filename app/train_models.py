...
def train_take_keep_classifier():
    ...
    n_samples = 300
    gas_value = np.random.randint(100, 1025, size=n_samples)  # Gas value between 100 and 1024
    distance = np.random.uniform(0, 28, size=n_samples)  # Distance between 1.0 and 27.999..
